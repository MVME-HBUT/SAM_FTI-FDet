default_scope = 'mmdet'
custom_imports = dict(imports=['mmdet.FTI-FDet'], allow_failed_imports=False)
...
model = dict(
    ...
    panoptic_head=dict(
        type='FTIMask2FormerHead',
        decoder_plus=True,
        mask_decoder=dict(
            type='FTISamMaskDecoder',
            hf_pretrain_name=hf_sam_pretrain_name,
            init_cfg=dict(type='Pretrained', checkpoint=hf_sam_pretrain_ckpt_path)),
